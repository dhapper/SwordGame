...
public class DrawSwordInfo {
	...
	public void paint(DrawBattle drawBattle, PlayerBattleState player, Graphics g){
		
		this.bgW = drawBattle.buttonWidth*5/2;
		this.bgH = bgW;
		this.bgX = drawBattle.battleWidth/2 - this.bgW/2;
		...
		this.stringOffsetY = drawBattle.battleHeight/15;
		...
		//draw sword
		try {
			Image sword = ImageIO.read(new File("res/swords/sword - "+player.getInactiveSword().getName()+".png"));
