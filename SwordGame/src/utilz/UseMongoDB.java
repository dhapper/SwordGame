...
public class UseMongoDB {
	...
	public Player getPlayer(String username) {
		...
		if(cursor.hasNext()) {
	        ...
	        List<Integer> modelList = Doc.getList("model", Integer.class);
            int[] modelArray = modelList.stream().mapToInt(i -> i).toArray();
            player.setModel(modelArray);
	...
	public void setActiveItem(Player player, String itemType, String itemName) {
	    initConnection("inventory");
	    Document query = new Document("username", player.getUsername());
	    ...
	    switch (itemType) {
	        case "ACTIVE_SWORD":
	            update.put("active sword", itemName);
	            break;
	        case "INACTIVE_SWORD":
	            update.put("inactive sword", itemName);
	            break;
	        case "ACTIVE_SHIELD":
	            update.put("active shield", itemName);
	            break;
	        case "ACTIVE_ARMOUR":
	            update.put("active armour", itemName);
	            break;
	        default:
	            // Handle invalid itemType
	            return;
	    }
